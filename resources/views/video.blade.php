...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        }@media (min-width:768px){.md\:border-t-0{border-top-width:0}.md\:border-l
        {border-left-width:1px}.md\:grid-cols-2{grid-template-columns:repeat(2,minmax(0,1fr))}}
    ...
    <body>
        <div class="container">
            <div class="row text-center">
                <div class="col-md-12">
                    <h1>Video Viewer : ({{$video->viewer}})</h1>
